	...
	{	
        ...
        function body()
        {
                ...
                echo '<span class ="subtitle">'
                     ...
                     .'</span>'   
                     .'<span class="body">'
                     .   $displaydata->formatdata('telephonetype')
                     .'</span>';
                     $displaydata->buildControlssm($_SESSION['displaydata'][$_SESSION ["displaydata"] ["name"]]["line"]);
                echo '</td>'
                     .'</tr>';
                echo '<tr>';     
                echo  '<td class="subtitle">Number: '
                     .'<span class="body">'
                     .   $displaydata->formatdata('telephonenumber')
                     .'</span>'
                     . '</td>'
                     .'</tr>'
                     .'<tr>'   
